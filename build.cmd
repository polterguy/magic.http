...
dotnet nuget push magic.http.contracts/magic.http.contracts/bin/Release/magic.http.contracts.%version%.nupkg -k %key% -s https://api.nuget.org/v3/index.json
...
dotnet nuget push magic.http.services/magic.http.services/bin/Release/magic.http.%version%.nupkg -k %key% -s https://api.nuget.org/v3/index.json
